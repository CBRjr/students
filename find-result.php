                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="rollid">Enter Your Index Number</label>
                                        <input type="text" class="form-control" id="rollid" placeholder="Enter Your Index Number" autocomplete="off" name="rollid">
                                	</div>
                               <div class="form-group">
